...
class EGNNDynamics(nn.Module):
    ...
    def forward(self, xh_atoms, xh_residues, t, mask_atoms, mask_residues):
        ...
        # NOTE: here, temporary change to see the output when operating solely on the ligand
        # x = x_atoms
        # h = h_atoms
        # mask = mask_atoms
    ...
    # NOTE: added by jeandmr
    def get_edges_ligand(self, batch_mask_ligand, x_ligand):
        adj_ligand = batch_mask_ligand[:, None] == batch_mask_ligand[None, :]
